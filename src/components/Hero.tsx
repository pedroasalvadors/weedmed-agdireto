  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative">
        ...
        <motion.div
          className="absolute -right-20 md:-right-10 lg:right-8 -bottom-16 md:-bottom-44 lg:-bottom-40 pointer-events-none"
          initial={{ x: 50 }}
          animate={{ x: 0 }}
        ...
        >
          <img
            ...
            className="h-[400px] md:h-[500px] lg:h-[800px] w-auto object-contain object-bottom"
            fetchPriority="high"
            decoding="async"
          />
        </motion.div>
